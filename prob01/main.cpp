...
int main()
{
  ...
  char my_char1 = 'J';
  short my_short1 = 74 ;
  std::cout << "The ASCII value for " << my_short1 << " is " << static_cast <short>(my_char1) << '\n';
  ...
  // longer alphabetic
  /* The character is no longer alphabetic because char is reading an increase by 1 from z
  , since z is the last letter of the alphabet it increases to a numerical value. */
  char my_char3 = 'z';
  my_char3 = my_char3+1 ;
 ...
 /* my_short2 became negative after adding 1 because 32767 is the max positive value for short,
 leading to a overflow error. my_int2 did not become negative because an unsigned int can store more positive values than
 short because it can store only positives and does not store negatives. */
